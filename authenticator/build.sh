...
${nuget_cmd} install src/MX.Wire4/packages.config -o packages;
...
cp packages/MX.Wire4.0.0.6/lib/net45/MX.Wire4.dll bin/MX.Wire4.dll;
...
bin/RestSharp.dll,bin/MX.Wire4.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/MX.Wire4.Authenticator.dll \
-recurse:'src/MX.Wire4/*.cs' \
-doc:bin/MX.Wire4.Authenticator.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/MX.Wire4.Authenticator.dll was created successfully"
fi
