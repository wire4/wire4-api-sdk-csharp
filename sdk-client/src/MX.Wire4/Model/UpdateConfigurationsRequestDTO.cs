...
namespace MX.Wire4.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpdateConfigurationsRequestDTO :  IEquatable<UpdateConfigurationsRequestDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateConfigurationsRequestDTO" /> class.
        /// </summary>
        /// <param name="configurations">Listado de configuraciones para actualizar (required).</param>
        public UpdateConfigurationsRequestDTO(List<ConfigurationsLimits> configurations = default(List<ConfigurationsLimits>))
        {
            // to ensure "configurations" is required (not null)
            if (configurations == null)
            {
                throw new InvalidDataException("configurations is a required property for UpdateConfigurationsRequestDTO and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Listado de configuraciones para actualizar</value>
        [DataMember(Name="configurations", EmitDefaultValue=false)]
        public List<ConfigurationsLimits> Configurations { get; set; }
        ...
        {
            return this.Equals(input as UpdateConfigurationsRequestDTO);
        }

        /// <summary>
        /// Returns true if UpdateConfigurationsRequestDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateConfigurationsRequestDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateConfigurationsRequestDTO input)
        {
            if (input == null)
                return false;
