...
namespace MX.Wire4.Model
{
        ...
        public partial class AmountRequest :  IEquatable<AmountRequest>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="amountLimit">Es el nuevo monto límite que reemplazará al actual, un monto de 0.0 implica que no hay límite. (required).</param>
        ...
        /// <param name="currencyCode">Es el código de divisa de la cuenta. Es en el formato estándar de 3 dígitos, por ejemplo para el peso mexicano: &lt;b&gt;MXP&lt;/b&gt;, para el dólar estadounidense: &lt;b&gt;USD&lt;/b&gt;. (required).</param>
        /// <param name="previousAmountLimit">Es el monto límite registrado actualmente, un monto de 0.0 implica que no hay límite. (required).</param>
        /// <param name="returnUrl">Es la dirección URL a la que se redirigirá en caso de éxito. Se valida hasta 512 caracteres. (required).</param>
        ...
        /// </summary>
        /// <value>Es el nuevo monto límite que reemplazará al actual, un monto de 0.0 implica que no hay límite.</value>
        ...
        /// </summary>
        /// <value>Es el código de divisa de la cuenta. Es en el formato estándar de 3 dígitos, por ejemplo para el peso mexicano: &lt;b&gt;MXP&lt;/b&gt;, para el dólar estadounidense: &lt;b&gt;USD&lt;/b&gt;.</value>
        ...
        /// </summary>
        /// <value>Es el monto límite registrado actualmente, un monto de 0.0 implica que no hay límite.</value>
        ...
        /// </summary>
        /// <value>Es la dirección URL a la que se redirigirá en caso de éxito. Se valida hasta 512 caracteres.</value>
