...
namespace MX.Wire4.Model
{
        ...
        public partial class Institution :  IEquatable<Institution>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="companyName">Es la razón social de la institución..</param>
        /// <param name="key">Es la clave de BANXICO que pertenece a la institución..</param>
        /// <param name="name">Es el nombre de la institución..</param>
        /// <param name="rfc">Es el Registro Federal de Contribuyente (RFC) que pertenece a la institución bancaria..</param>
        public Institution(string companyName = default(string), string key = default(string), string name = default(string), string rfc = default(string))
        {
        ...
        /// </summary>
        /// <value>Es la razón social de la institución.</value>
        ...
        /// </summary>
        /// <value>Es la clave de BANXICO que pertenece a la institución.</value>
        ...
        /// </summary>
        /// <value>Es el nombre de la institución.</value>
        ...
        /// </summary>
        /// <value>Es el Registro Federal de Contribuyente (RFC) que pertenece a la institución bancaria.</value>
