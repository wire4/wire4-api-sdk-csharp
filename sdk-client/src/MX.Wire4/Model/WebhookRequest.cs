...
namespace MX.Wire4.Model
{
        ...
        public partial class WebhookRequest :  IEquatable<WebhookRequest>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="events">Tipos de eventos de los cuales Wire4 te enviará información, para mas referencia sobre los tipos de eventos soportados, revise la siguiente liga: https://developers.wire4.mx/#section/Eventos . (required).</param>
        /// <param name="name">Nombre del webhook. (required).</param>
        /// <param name="url">URL a la cual Wire4 enviará las notificaciones cuando un evento ocurra. (required).</param>
        ...
        /// </summary>
        /// <value>Tipos de eventos de los cuales Wire4 te enviará información, para mas referencia sobre los tipos de eventos soportados, revise la siguiente liga: https://developers.wire4.mx/#section/Eventos .</value>
