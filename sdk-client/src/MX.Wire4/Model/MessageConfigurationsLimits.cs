...
namespace MX.Wire4.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MessageConfigurationsLimits :  IEquatable<MessageConfigurationsLimits>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageConfigurationsLimits" /> class.
        /// </summary>
        /// <param name="configurations">Lista de configuraciones pertenecientes al contrato.</param>
        public MessageConfigurationsLimits(List<ConfigurationsLimits> configurations = default(List<ConfigurationsLimits>))
        {
        ...
        /// </summary>
        /// <value>Lista de configuraciones pertenecientes al contrato</value>
        ...
        {
            return this.Equals(input as MessageConfigurationsLimits);
        }

        /// <summary>
        /// Returns true if MessageConfigurationsLimits instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageConfigurationsLimits to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageConfigurationsLimits input)
        {
            if (input == null)
                return false;
