...
namespace MX.Wire4.Model
{
        ...
        public partial class TransactionOutgoing :  IEquatable<TransactionOutgoing>, IValidatableObject
    {
        ...
        public TransactionOutgoing(decimal? amount = default(decimal?), Account beneficiary = default(Account), string beneficiaryAccount = default(string), string beneficiaryBankKey = default(string), string concept = default(string), string currencyCode = default(string), List<string> email = default(List<string>), string orderId = default(string), int? reference = default(int?))
        {
