...
namespace MX.Wire4.Model
{
        ...
        public partial class Person :  IEquatable<Person>, IValidatableObject
    {
        ...
        public Person(string lastName = default(string), string middleName = default(string), string name = default(string))
        {
            ...
            if (middleName == null)
            {
                throw new InvalidDataException("middleName is a required property for Person and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Apellido Materno del propietario de la cuenta</value>
        ...
        /// </summary>
        /// <value>Apellido Paterno del propietario de la cuenta</value>
        ...
        /// </summary>
        /// <value>Nombre(s) del propietario de la cuenta</value>
