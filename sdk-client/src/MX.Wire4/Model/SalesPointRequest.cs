...
namespace MX.Wire4.Model
{
        ...
        public partial class SalesPointRequest :  IEquatable<SalesPointRequest>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="accessIp">IP desde donde se recibiran las peticiones de este punto de venta (required).</param>
        /// <param name="account">Número de cuenta CLABE donde se realizará el deposito del cobro CoDi (required).</param>
        /// <param name="name">Nombre del punto de venta (required).</param>
        /// <param name="notificationsUrl">URL para envíar notificaciones CoDi al punto de venta (required).</param>
        ...
        /// </summary>
        /// <value>IP desde donde se recibiran las peticiones de este punto de venta</value>
        ...
        /// </summary>
        /// <value>Número de cuenta CLABE donde se realizará el deposito del cobro CoDi</value>
        ...
        /// </summary>
        /// <value>URL para envíar notificaciones CoDi al punto de venta</value>
