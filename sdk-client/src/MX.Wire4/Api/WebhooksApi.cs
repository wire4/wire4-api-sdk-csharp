...
namespace MX.Wire4.Api
{
        ...
        public interface IWebhooksApi : IApiAccessor
    {
        ...
        /// <param name="webhookId">Es el identificador del webhook. Ejemplo: wh_54a932866f784b439bc625c0f4e04e12</param>
        ...
        ApiResponse<WebhookResponse> GetWebhookWithHttpInfo (string authorization, string webhookId);
        /// <summary>
        ...
        System.Threading.Tasks.Task<WebhookResponse> GetWebhookAsync (string authorization, string webhookId);
        ...
        System.Threading.Tasks.Task<ApiResponse<WebhookResponse>> GetWebhookAsyncWithHttpInfo (string authorization, string webhookId);
        /// <summary>
        /// Consulta la lista de Webhooks
        /// </summary>
        /// <remarks>
        ...
        public partial class WebhooksApi : IWebhooksApi
    {
        ...
        /// <param name="webhookId">Es el identificador del webhook. Ejemplo: wh_54a932866f784b439bc625c0f4e04e12</param>
        /// <returns>WebhookResponse</returns>
        public WebhookResponse GetWebhook (string authorization, string webhookId)
        {
             ApiResponse<WebhookResponse> localVarResponse = GetWebhookWithHttpInfo(authorization, webhookId);
        ...
        /// <param name="webhookId">Es el identificador del webhook. Ejemplo: wh_54a932866f784b439bc625c0f4e04e12</param>
        /// <returns>ApiResponse of WebhookResponse</returns>
        public ApiResponse< WebhookResponse > GetWebhookWithHttpInfo (string authorization, string webhookId)
        {
        ...
        /// <param name="webhookId">Es el identificador del webhook. Ejemplo: wh_54a932866f784b439bc625c0f4e04e12</param>
        /// <returns>Task of WebhookResponse</returns>
        public async System.Threading.Tasks.Task<WebhookResponse> GetWebhookAsync (string authorization, string webhookId)
        {
             ApiResponse<WebhookResponse> localVarResponse = await GetWebhookAsyncWithHttpInfo(authorization, webhookId);
             return localVarResponse.Data;
        ...
        /// <param name="webhookId">Es el identificador del webhook. Ejemplo: wh_54a932866f784b439bc625c0f4e04e12</param>
        /// <returns>Task of ApiResponse (WebhookResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<WebhookResponse>> GetWebhookAsyncWithHttpInfo (string authorization, string webhookId)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling WebhooksApi->GetWebhook");
