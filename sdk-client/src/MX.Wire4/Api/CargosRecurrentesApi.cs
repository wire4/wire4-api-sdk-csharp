...
namespace MX.Wire4.Api
{
    ...
    /// </summary>
        public interface ICargosRecurrentesApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ConfirmRecurringCharge> RegisterRecurringChargeUsingPOSTAsync (RecurringChargeRequest body, string authorization);
        ...
        System.Threading.Tasks.Task<ApiResponse<ConfirmRecurringCharge>> RegisterRecurringChargeUsingPOSTAsyncWithHttpInfo (RecurringChargeRequest body, string authorization);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class CargosRecurrentesApi : ICargosRecurrentesApi
    {
        private MX.Wire4.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="CargosRecurrentesApi"/> class.
        /// </summary>
        /// <returns></returns>
        public CargosRecurrentesApi(String basePath)
        {
        ...
        /// <returns></returns>
        public CargosRecurrentesApi(MX.Wire4.Client.Configuration configuration = null)
        {
        ...
        /// <param name="authorization">Header para token</param>
        /// <returns>ApiResponse of ConfirmRecurringCharge</returns>
        public ApiResponse< ConfirmRecurringCharge > RegisterRecurringChargeUsingPOSTWithHttpInfo (RecurringChargeRequest body, string authorization)
        {
