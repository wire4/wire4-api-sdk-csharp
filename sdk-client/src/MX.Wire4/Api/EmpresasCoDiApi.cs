...
namespace MX.Wire4.Api
{
        ...
        public partial class EmpresasCoDiApi : IEmpresasCoDiApi
    {
        ...
        /// <summary>
        /// Registro de empresas CODI Registra una empresa para hacer uso de operaciones CODI. Es requerido tener el certificado emitido por BANXICO® asi como el Nombre de la empresa, Nombre comercial y RFC de la empresa.&lt;br/&gt;
        /// </summary>
        /// <exception cref="MX.Wire4.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">Información de la cuenta del beneficiario</param>
        /// <param name="authorization">Header para token</param>
