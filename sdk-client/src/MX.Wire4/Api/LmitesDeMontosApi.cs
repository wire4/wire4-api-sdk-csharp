...
namespace MX.Wire4.Api
{
        ...
        public interface ILmitesDeMontosApi : IApiAccessor
    {
        ...
        /// <param name="suscription">Identificador de la suscripción a esta API</param>
        ...
        public partial class LmitesDeMontosApi : ILmitesDeMontosApi
    {
        ...
        /// <summary>
        /// Consulta las configuraciones para el contrato asocaido al enrolamiento en la aplicación Consulta las configuraciones para el contrato asocaido al enrolamiento en la aplicación.
        /// </summary>
        /// <exception cref="MX.Wire4.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization">Header para token</param>
        /// <param name="suscription">Identificador de la suscripción a esta API</param>
        ...
        /// <summary>
        /// Actualiza las configuraciones por subscripción Actualiza las configuraciones de un contrato asociado a una subscripción
        /// </summary>
        /// <exception cref="MX.Wire4.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">updateConfigurationsResquestDTO</param>
        /// <param name="authorization">Header para token</param>
