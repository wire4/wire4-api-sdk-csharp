...
namespace MX.Wire4.Api
{
        ...
        public partial class PeticionesDePagoPorCoDiApi : IPeticionesDePagoPorCoDiApi
    {
        ...
        public ApiResponse< PaymentRequestCodiResponseDTO > ConsultCodiRequestByOrderIdWithHttpInfo (string authorization, string orderId, string salesPointId)
        {
            ...
            var localVarPath = "/codi/sales-point/{sales_point_id}/charges/{order_id}";
            ...
            if (salesPointId != null) localVarPathParams.Add("sales_point_id", this.Configuration.ApiClient.ParameterToString(salesPointId)); // path parameter
        ...
        public ApiResponse< CodiCodeQrResponseDTO > GenerateCodiCodeQRWithHttpInfo (CodiCodeRequestDTO body, string authorization, string salesPointId)
        {
            ...
            var localVarPath = "/codi/sales-point/{salesPointId}/charges";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (salesPointId != null) localVarPathParams.Add("salesPointId", this.Configuration.ApiClient.ParameterToString(salesPointId)); // path parameter
            if (authorization != null) localVarHeaderParams.Add("Authorization", this.Configuration.ApiClient.ParameterToString(authorization)); // header parameter
