...
namespace MX.Wire4.Api
{
        ...
        public interface ICuentasDeBeneficiariosSPIDApi : IApiAccessor
    {
        ...
        /// <param name="account">Cuenta del beneficiario, puede ser CLABE (18 dígitos), Tarjeta de débito  (TDD, 16 dígitos) o número de celular (10 dígitos). (optional)</param>
        /// <param name="beneficiaryBank">Es la clave del banco beneficiario. Se puede obtener del catalogo de &lt;a href&#x3D;\&quot;#operation/getAllInstitutionsUsingGET\&quot;&gt;instituciones.&lt;/a&gt; (optional)</param>
