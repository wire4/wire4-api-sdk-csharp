...
namespace MX.Wire4.Api
{
        ...
        public interface IPuntosDeVentaCoDiApi : IApiAccessor
    {
        ...
        /// <param name="body">salesPointRequest</param>
        ...
        ApiResponse<SalesPointRespose> CreateSalesPointWithHttpInfo (SalesPointRequest body, string authorization, string companyId, string name = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<SalesPointRespose> CreateSalesPointAsync (SalesPointRequest body, string authorization, string companyId, string name = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<SalesPointRespose>> CreateSalesPointAsyncWithHttpInfo (SalesPointRequest body, string authorization, string companyId, string name = null);
        /// <summary>
        /// Obtiene los puntos de venta asociados a una empresa
        /// </summary>
        /// <remarks>
        ...
        public partial class PuntosDeVentaCoDiApi : IPuntosDeVentaCoDiApi
    {
        ...
        /// <summary>
        /// Registra un punto de venta asociado a una empresa Registra un punto de venta desde donde se emitaran los cobros CODI®, el punto de venta se debe asociar a un cuenta cableregistrada previamente ante Banxico para realizar cobros con CODI®
        /// </summary>
        /// <exception cref="MX.Wire4.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">salesPointRequest</param>
        /// <param name="authorization">Header para token</param>
        ...
        /// <param name="name"> (optional)</param>
        /// <returns>SalesPointRespose</returns>
        public SalesPointRespose CreateSalesPoint (SalesPointRequest body, string authorization, string companyId, string name = null)
        {
             ApiResponse<SalesPointRespose> localVarResponse = CreateSalesPointWithHttpInfo(body, authorization, companyId, name);
        ...
        /// <param name="name"> (optional)</param>
        /// <returns>ApiResponse of SalesPointRespose</returns>
        public ApiResponse< SalesPointRespose > CreateSalesPointWithHttpInfo (SalesPointRequest body, string authorization, string companyId, string name = null)
        {
            ...
            var localVarPath = "/codi/companies/{company_id}/salespoint";
        ...
        /// <param name="name"> (optional)</param>
        /// <returns>Task of SalesPointRespose</returns>
        public async System.Threading.Tasks.Task<SalesPointRespose> CreateSalesPointAsync (SalesPointRequest body, string authorization, string companyId, string name = null)
        {
             ApiResponse<SalesPointRespose> localVarResponse = await CreateSalesPointAsyncWithHttpInfo(body, authorization, companyId, name);
             return localVarResponse.Data;
        ...
        /// <param name="name"> (optional)</param>
        /// <returns>Task of ApiResponse (SalesPointRespose)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<SalesPointRespose>> CreateSalesPointAsyncWithHttpInfo (SalesPointRequest body, string authorization, string companyId, string name = null)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling PuntosDeVentaCoDiApi->CreateSalesPoint");
        ...
        /// <summary>
        /// Obtiene los puntos de venta asociados a una empresa Obtiene los puntos de venta asociados a una empresa en las cuales se hacen operaciones CODI®
        /// </summary>
        /// <exception cref="MX.Wire4.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization">Header para token</param>
        /// <param name="companyId">El identificador de la empresa</param>
